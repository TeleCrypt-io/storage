...
The tag points at the merged repository commit. The CLI workflow runs with `cli/` as its working
directory and uses the verification scripts in `cli/scripts/`.
